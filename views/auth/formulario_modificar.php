...
<fieldset class="form__fieldset">
    <div class="form__campo">
        <label class="form__label" for="disponible">Disponible</label>
        <select class="form__select" name="disponible" id="disponible">
            <option value="0" <?php echo ($usuarios->disponible === '0' ? 'selected' : ''); ?>>NO</option>
            <option value="1" <?php echo ($usuarios->disponible === '1' ? 'selected' : ''); ?>>SI</option>
        </select>
    </div>
</fieldset>
...
if ($_SESSION['usuario'] === '3') { ?>
    <fieldset class="form__fieldset">
        <div class="form__campo">
            ...
            <select class="form__select" name="estado" id="estado">
                <option value="0" <?php echo ($usuarios->estado === '0' ? 'selected' : ''); ?>>Inactivo</option>
                <option value="1" <?php echo ($usuarios->estado === '1' ? 'selected' : ''); ?>>Activo</option>
            </select>
        </div>
    </fieldset>
<?php } ?>